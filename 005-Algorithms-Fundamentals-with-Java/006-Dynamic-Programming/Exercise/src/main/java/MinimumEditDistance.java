...
public class MinimumEditDistance {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // open reader and declare variables from console input, close reader
        ...
        // declare matrix for dp values
        int[][] dp = new int[first.length + 1][second.length + 1];

        // iterative fill base data
        ...
        // get result from dp matrix and print to console
